...
% le a imagem
im1 = imread('C:\Users\Windows 10Pro\Desktop\Populars\im1.png');

% calcula o histograma em tons de cinza
H = psrGrayHistogram(im1);

SearchAgents_no=50; % Number of search agents

Function_name='F0'; % Name of the test function that can be from F1 to F23 (Table 1,2,3 in the paper)
...
[Best_score,Best_pos,GWO_cg_curve]=GWO(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,H);
im2 = psrMultiLimiarizacao2(im1,Best_pos,0);
imwrite(im2, 'saida.jpg');
